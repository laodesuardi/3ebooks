    ...
    <section id="story" class="">
          ...
          <div class="flex w-full items-center justify-center flex-wrap">
            ...
            <div class="w-full self-center order-2 py-4 lg:w-1/2">
                <div class="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                    <div class="w-full max-w-md space-y-8">
                      <div>                        
                        <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Masukan Nama, No. Whatsapp, dan Email Anda untuk mendownload 3 buah Ebook Gratis</h2>                        
                      </div>
            ...
            <div class="w-full flex justify-center item-center lg:w-1/2 order-1 mb-8 ">             
                <div class="bg-cover h-[350px] w-[350px] md:h-[450px] md:w-[450px] rounded-xl md:pb-12" style="background-image: url(img/1.jpg)">
                </div>          
            </div>  
