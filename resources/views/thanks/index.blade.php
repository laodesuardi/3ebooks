...
{{--  @section('container')
    ...
    @endif
<h1>Terima kasih sudah memasukan data</h1>
@endsection  --}}


@section('container')
  {{--  @if(session()->has('success'))
  <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative" id="box-alert" role="alert">
    
    <span class="block sm:inline">{{ session('success') }}</span>
    <button type="button" id="tombol-close" data-bs-dismiss="alert" aria-label="Close">
